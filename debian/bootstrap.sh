...
$APT_GET_INSTALL ack-grep arandr aspell-en aspell-es autojump curl emacs25 \
                 ...
                 xbacklight xclip fonts-hack-ttf
...
SUBSYSTEM=="drm", ACTION=="change", ENV{HOME}="/home/omab", ENV{XAUTHORITY}="/home/omab/.Xauthority", ENV{DISPLAY}=":0.0", ENV{HDMI_SLEEP}="5" RUN+="/home/omab/.bin/fix-screen"
EOF
)
...
$APT_GET update
$APT_GET_INSTALL --allow-unauthenticated google-chrome-stable virtualbox virtualbox-ext-pack docker-ce
